...
//                                       //short push in content end
                                      ...
                                      var swipersss = document.querySelectorAll('.card__animeee');
...
// const photos = [
//   'animeLists_Imgs/Black Butler.jpe',
//   'animeLists_Imgs/4305090653ee4239dd0d797f1a4a6bdf.jpe',
//   'animeLists_Imgs/demon slayer.jpe'
// ];
...
//   currentIndex = (currentIndex + 1) % photos.length; // Increment index and loop back to 0 if it exceeds the length
//   console.log(currentIndex )
// }

// // Initial call to change the photo
// changePhoto();